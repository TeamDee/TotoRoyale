...
public class FrequentlyUsedPatterns {
    ...
    static Pattern MoveServerPromptMssgPattern = Pattern.compile("^MAKE YOUR MOVE IN GAME ([\\d\\w]*) WITHIN ([\\d.]*) SECOND[S]*: MOVE ([\\d]*) PLACE ([\\w+]*)$");
    static Pattern GameMovePlayerMssgPattern = Pattern.compile("^GAME ([\\d\\w]*) MOVE ([\\d]*) PLAYER ([\\d]*) ([\\w\\d ]*)$");
    static Pattern GameForfeitedMssgPattern = Pattern.compile("^GAME ([\\d\\w]*) MOVE ([\\d]*) PLAYER ([\\d]*) FORFEITED:([\\w ]*)$");
    static Pattern GameLostMssgPattern = Pattern.compile("^GAME ([\\d\\w]*) MOVE ([\\d]*) PLAYER ([\\d]*) LOST:([\\w ]*)$");
    static Pattern GameOverMssgPattern = Pattern.compile("^GAME ([\\d\\w]*) OVER PLAYER ([\\d]*) ([\\d\\w]*) PLAYER ([\\d]*) ([\\d\\w]*)$");
